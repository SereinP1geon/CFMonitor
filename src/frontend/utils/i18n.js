...
const translations = reactive({
  en: {
    ...
    online: 'Online',
    offline: 'Offline',
    noServer: 'No servers available. Add one in the',
    noServerSuffix: '.',
    ...
    serverUnavailableDescription: 'This server does not exist or its data could not be loaded.',
    ago: 'ago',
    uptime: 'Uptime',
  ...
  zh: {
    ...
    serverUnavailableDescription: '该服务器不存在，或暂时无法加载其数据。',
    ago: '前',
    uptime: '运行时间',
    architecture: '架构',
    os: '操作系统',
